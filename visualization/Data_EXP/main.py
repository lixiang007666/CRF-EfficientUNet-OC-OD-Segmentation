...
net3 = pd.read_csv('run-radam-tag-batch_categorical_accuracy.csv', usecols=['Step', 'Value'])
ax.plot(net3 .Step, net3 .Value, lw=1.5, label='Net-3', color='blue')
net2 = pd.read_csv('run-ranger-tag-batch_categorical_accuracy.csv', usecols=['Step', 'Value'])
ax.plot(net2.Step, net2.Value, lw=1.5, label='Ranger', color='red')
net4 = pd.read_csv('run-Adam-tag-batch_categorical_accuracy.csv', usecols=['Step', 'Value'])
ax.plot(net4 .Step, net4 .Value, lw=1.5, label='Net-4', color='green')
net5 = pd.read_csv('run-SGD-tag-batch_categorical_accuracy.csv', usecols=['Step', 'Value'])
